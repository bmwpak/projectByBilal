...
<div class="container">
    <div class="status">
		...
		<?php 
		echo $_POST['pp_Amount'];?><br/><?php
		echo $_POST['pp_AuthCode'];?><br/><?php
		//  && 
		echo $_POST['pp_ResponseCode'];?><br/><?php
		echo $_POST['pp_MerchantID']; ?><br/><?php
		echo $_POST['pp_SecureHash'];?><br/><?php
		echo $_POST['pp_TxnRefNo'];?><br/><?php
		echo $_POST['pp_RetreivalReferenceNo'];
		?>
    </div>
    <a href="http://localhost:3000/ads" class="btn-link">Back to Products</a>
