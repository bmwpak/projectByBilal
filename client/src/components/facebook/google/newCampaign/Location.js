        ...
        <>
            ...
            <PlacesAutocomplete
                ...
                >
                    ...
                    <div>
                        <input style={{marginLeft:'-27%',width:'70%',padding:'5px',border:'2px solid grey'}}
                         autoComplete="off"
                        {...getInputProps({
                        ...
                        />
                        <div className="autocomplete-dropdown-container" style={{marginLeft:'3%',width:'51%',textAlign:'left'}} >
